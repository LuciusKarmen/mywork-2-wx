...
const S = true, b = "mp-weixin", T = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), A = b, P = I('{"address":["127.0.0.1","192.168.107.1","192.168.119.1","10.90.119.48"],"servePort":7000,"debugPort":9000,"initialLaunchType":"local","skipFiles":["<node_internals>/**","D:/360Downloads/HBuilderX.4.57.2025032507/HBuilderX/plugins/unicloud/**/*.js"]}'), C = I('[{"provider":"aliyun","spaceName":"karmen-luious","spaceId":"mp-f789f67b-bfef-4610-9275-4b584f503100","clientSecret":"cI8CsxxoF+tDkkz+KIZfSA==","endpoint":"https://api.next.bspapp.com"}]') || [];
let O = "";
try {
  O = "__UNI__2DEB4E2";
} catch (e2) {
